CaliforniaInternet.Routers.Main = Backbone.Router.extend({
    ...
    homePage: function() {
      ...
      $("#text-one-one").delay(3900).fadeIn("slow").delay(2000).fadeOut(300);
      ...
      $("#graphics-six-one").delay(21000).fadeIn("slow")
      $("#graphics-six").delay(21500).fadeIn("slow")

      $("#cta-text").delay(22500).animate({
         marginTop: "-7px"
      }, 350, function() {
          $("#cta-text").animate({
             marginTop: "0px"
